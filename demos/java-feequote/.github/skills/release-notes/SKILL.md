...
1. Run `scripts/release-notes.sh <from-tag> <to-tag>` (on Windows, `pwsh scripts/release-notes.ps1 <from-tag> <to-tag>`) from the repository root. It prints commits grouped by conventional-commit type.
